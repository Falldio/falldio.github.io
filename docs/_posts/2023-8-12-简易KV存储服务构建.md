...
> **NOTE**：本文为6.824（分布式系统）Lab 3的回顾，实验要求见[这里](https://pdos.csail.mit.edu/6.824/labs/lab-mr.html)。因为要遵守课程的**Collaboration Policy**，所以本文不会分享任何实现细节的代码（可能还是会有一些逻辑性的简单代码帮助阐明思路）。
