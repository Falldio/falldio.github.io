...
tags:
    - Go
    - 翻译
summary: 本文译自[Go's Error Handling Is a Form of Storytelling](https://preslav.me/2023/04/14/golang-error-handling-is-a-form-of-storytelling/)，这篇文章讲述了Golang中异常的用法，这种把异常处理当作叙事手法的视角很新奇，文章也提供了一些写error message的范例。但这篇文章不包括Go error的实现原理，可以选择性的阅读。
---
