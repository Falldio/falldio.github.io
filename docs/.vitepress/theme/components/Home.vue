...
<template>
    <section class="container">
        <div class="intro columns-2 flex flex-row max-md:flex-col py-16 mx-auto max-w-3xl justify-center items-center">
        ...
        <div class="latest-posts p-8" v-if="posts.length">
            <h2 class="text-2xl font-semibold">Why do you write like you needed it to survive...</h2>
            <div class="homecard-container grid grid-cols-3 gap-4 my-4 max-md:grid-cols-1">
